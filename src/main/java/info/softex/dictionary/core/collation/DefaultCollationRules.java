...
/**
 * BasicCollationRules are very similar to the default en_US collation rules which 
 * are modified to satisfy the dictionary sorting rules. They are used as a base 
 * for building other collation tables.
 * 
 * @since version 2.6, 09/27/2011
 * 
