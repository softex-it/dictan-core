...
public class FDBDynamicListSet extends AbstractDynamicListSet<String> {
	...
	protected List<String> restoreBlockContent(BasicCacheBlock<String> block) throws Exception {
		...
		log.trace("Restoring block elements: start {}, end {}", startRow, endRow);
		...
		log.debug("Restored FDB Block: {}, size: {}, time: {} ms", new Object[] {block, strongElements.size(), System.currentTimeMillis() - start});
